            ...
            <div class="Vehicle_info">
                <div class="Vehicle_info_form">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="type" placeholder="Motorcycle" disabled>
                        </div>
                    </div>
                    <!-- plate no -->
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="plate_no" value="{{$motorcycle->plate_no}}" disabled>
                        </div>
                    </div>
                    <!-- motorcycle model -->
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="model" value="{{$motorcycle->model}}" disabled>
                        </div>
                    </div>
                    <!-- motorcycle color -->
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="color" value="{{$motorcycle->color}}" disabled>
                        </div>
                    </div>
                    <!-- documents upload -->
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="upload_docs" value="{{$motorcycle->upload_docs}}" disabled>
                        </div>
                    </div>
                    <!-- buttons -->
                    <div class="form-group row  ">
