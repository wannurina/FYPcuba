                      ...
                      <form method="POST" action="{{ route('students.login') }}">
                          ...
                          <div class="forms-gds1 editContent" data-selector=".editContent" style="">
                            <div class="form-group row">
                                <label for="MatricNo" class="col-md-4 col-form-label text-md-right">{{ __('Matric No') }}</label>

                                <div class="col-md-6">
                                    <input id="MatricNo" type="MatricNo" class="form-control @error('MatricNo') is-invalid @enderror" name="MatricNo" value="{{ old('MatricNo') }}" required autocomplete="MatricNo" autofocus>
